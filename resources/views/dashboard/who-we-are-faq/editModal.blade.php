    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- <form action="{{ route('who-we-are-faq.update', 'test') }}" method="post" enctype="multipart/form-data">
                    {{ method_field('patch') }}
                    @csrf -->
                    ...
                    <div class="form-group">
                        <label>{{ trans('main.Question') }} {{ trans('main.In Arabic') }}</label>
                    ...
                    <!-- name_en -->
                    <div class="form-group">
                        <label>{{ trans('main.Question') }} {{ trans('main.In English') }}</label>
                    ...
                    <!-- details_ar -->
                    <div class="form-group">
                        <label>{{ trans('main.Answer') }} {{ trans('main.In Arabic') }}</label>
                    ...
                    <!-- details_en -->
                    <div class="form-group">
                        <label>{{ trans('main.Answer') }} {{ trans('main.In English') }}</label>
