    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- <form action="{{ route('partener.update', 'test') }}" method="post" enctype="multipart/form-data">
                    {{ method_field('patch') }}
                    @csrf -->
                    ...
                    <div class="form-group">
                        ...
                        <input id="update_url" type="text" class="form-control url" name="url" placeholder="{{ trans('main.Url') }}" required>
                    </div>
